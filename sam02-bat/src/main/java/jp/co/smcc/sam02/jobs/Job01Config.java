...
import jp.co.smcc.sam02.config.JobBaseContextConfig;
import jp.co.smcc.sam02.job01.Employee;
import jp.co.smcc.sam02.job01.EmployeeProcessor;

@Configuration
@Import(JobBaseContextConfig.class)
@ComponentScan("jp.co.smcc.sam02.job01")
@MapperScan(basePackages = "jp.co.smcc.sam02.job01", sqlSessionFactoryRef = "jobSqlSessionFactory")
